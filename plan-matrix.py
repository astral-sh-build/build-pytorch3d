...
PYTORCH_CUDA_VERSIONS: dict[tuple[str, str], list[str]] = {
    ...
    ("2.10", "x86_64"): ["12.6", "12.8", "12.9"],
    ("2.10", "aarch64"): ["12.6", "12.8", "12.9"],
    ("2.11", "x86_64"): ["12.6", "12.8", "12.9"],
    ("2.11", "aarch64"): ["12.6", "12.8", "12.9"],
    # CUDA 13 has an unresolved upstream linker failure:
